...
describe('ArtistEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set GITHUB_API2_TEST_ARTIST_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['GITHUB_API2_TEST_ARTIST_ENTID']
  ...
  idmap = env['GITHUB_API2_TEST_ARTIST_ENTID']
