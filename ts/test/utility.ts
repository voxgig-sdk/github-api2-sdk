...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.GITHUBAPI2_TEST_LIVE ||
    'TRUE' === process.env.GITHUBAPI2_TEST_OVERRIDE
  ) {
  ...
  m.GITHUBAPI2_TEST_EXPLAIN = process.env.GITHUBAPI2_TEST_EXPLAIN || m.GITHUBAPI2_TEST_EXPLAIN
