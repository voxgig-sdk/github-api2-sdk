...
func (sdk *GithubApi2SDK) OptionsMap() map[string]any {
...
func (sdk *GithubApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GithubApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GithubApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GithubApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GithubApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GithubApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GithubApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GithubApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GithubApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GithubApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *GithubApi2SDK) Artist(data map[string]any) GithubApi2Entity {
...
func (sdk *GithubApi2SDK) Image(data map[string]any) GithubApi2Entity {
