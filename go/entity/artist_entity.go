...
func NewArtistEntity(client *core.GithubApi2SDK, entopts map[string]any) *ArtistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArtistEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
