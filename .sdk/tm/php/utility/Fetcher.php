...
// GithubApi2 SDK utility: fetcher

class GithubApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GithubApi2SDK/1.0)';
    ...
    public static function call(GithubApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
