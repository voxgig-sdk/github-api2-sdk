...
class GithubApi2CacheFeature extends GithubApi2BaseFeature
{
    ...
    private function _through(GithubApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
