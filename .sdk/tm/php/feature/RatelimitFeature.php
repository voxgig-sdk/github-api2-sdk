...
// GithubApi2 SDK ratelimit feature
...
class GithubApi2RatelimitFeature extends GithubApi2BaseFeature
{
    ...
    private function _acquire(GithubApi2Context $ctx): void
    {
    ...
    private function _track(GithubApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
