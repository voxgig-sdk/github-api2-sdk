...
local result, err = client:Artist():list()
...
```lua
local artist = client:Artist()
artist:list()

-- artist:data_get() now returns the artist data from the last list
-- artist:match_get() returns the last match criteria
```
