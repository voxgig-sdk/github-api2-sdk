...
describe("ImageEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GITHUB_API2_TEST_IMAGE_ENTID JSON to run live")
      return
    end
...
function image_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GITHUB_API2_TEST_IMAGE_ENTID")
  ...
  if env["GITHUB_API2_TEST_LIVE"] == "TRUE" then
