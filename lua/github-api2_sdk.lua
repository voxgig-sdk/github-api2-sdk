...
local GithubApi2SDK = {}
GithubApi2SDK.__index = GithubApi2SDK
...
GithubApi2SDK._make_feature = _make_feature


function GithubApi2SDK.new(options)
  local self = setmetatable({}, GithubApi2SDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GithubApi2SDK:options_map()
...
function GithubApi2SDK:get_utility()
  return Utility.copy(self._utility)
end


function GithubApi2SDK:get_root_ctx()
  return self._rootctx
end


function GithubApi2SDK:prepare(fetchargs)
...
function GithubApi2SDK:direct(fetchargs)
...
-- by passing it.
function GithubApi2SDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GithubApi2SDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "GithubApi2SDK: graphql: " .. msg
    res.graphql = errors
  end
...
function GithubApi2SDK:Artist(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function GithubApi2SDK:Image(data)
...
function GithubApi2SDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GithubApi2SDK.new(sdkopts)
  sdk.mode = "test"
