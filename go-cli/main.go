// Command GithubApi2-cli is a CLI + REPL for the GithubApi2 SDK,
...
const prompt = "github-api2"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "artist image"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      GITHUB_API2_APIKEY (api key), GITHUB_API2_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: GITHUB_API2_APIKEY carries the API key and
	// GITHUB_API2_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("GITHUB_API2_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("GITHUB_API2_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewGithubApi2SDK(opts)
