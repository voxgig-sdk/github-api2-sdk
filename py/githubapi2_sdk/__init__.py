...
from githubapi2_sdk.utility import register
...
class GithubApi2SDK:
    ...
    def get_utility(self):
        return GithubApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GithubApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Artist(self, data=None) -> "ArtistEntity":
        ...
        from githubapi2_sdk.entity.artist_entity import ArtistEntity
        return ArtistEntity(self, data)


    def Image(self, data=None) -> "ImageEntity":
        """Entity factory: client.Image().list() / client.Image().load({"id": ...})."""
        from githubapi2_sdk.entity.image_entity import ImageEntity
        return ImageEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "GithubApi2SDK":
        if sdkopts is None:
            sdkopts = {}
