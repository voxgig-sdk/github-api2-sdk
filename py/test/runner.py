...
class GithubApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GithubApi2TestRunner.getenv("GITHUBAPI2_TEST_LIVE")
        override = GithubApi2TestRunner.getenv("GITHUBAPI2_TEST_OVERRIDE")
        ...
        explain = GithubApi2TestRunner.getenv("GITHUBAPI2_TEST_EXPLAIN")
