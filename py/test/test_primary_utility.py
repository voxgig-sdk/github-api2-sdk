...
from githubapi2_sdk.core.response import GithubApi2Response
from githubapi2_sdk.core.operation import GithubApi2Operation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return GithubApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = GithubApi2SDK.test(None, None)
    ...
    def test_feature_hook_basic(self):
        hook_client = GithubApi2SDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = GithubApi2SDK.test(None, None)
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GithubApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GithubApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GithubApi2SDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GithubApi2SDK.test(None, setup_opts)
