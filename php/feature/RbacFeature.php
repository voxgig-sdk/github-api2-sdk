...
class GithubApi2RbacFeature extends GithubApi2BaseFeature
{
    ...
    private function _required(GithubApi2Context $ctx): ?string
    {
    ...
    private function _reject(GithubApi2Context $ctx, string $required): void
    {
    ...
    private function _track(GithubApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
