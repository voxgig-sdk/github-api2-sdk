...
// GithubApi2 SDK clienttrack feature
...
class GithubApi2ClienttrackFeature extends GithubApi2BaseFeature
{
    ...
    public function PostConstruct(GithubApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GithubApi2-SDK';
