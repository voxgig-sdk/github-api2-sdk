...
class GithubApi2NetsimFeature extends GithubApi2BaseFeature
{
    ...
    private function _simulate(GithubApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GithubApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
