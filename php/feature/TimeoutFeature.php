...
// GithubApi2 SDK timeout feature
...
class GithubApi2TimeoutFeature extends GithubApi2BaseFeature
{
    ...
    private function _with_timeout(GithubApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GithubApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
