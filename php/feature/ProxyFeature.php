...
class GithubApi2ProxyFeature extends GithubApi2BaseFeature
{
    ...
    public function init(GithubApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GithubApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
