...
type Args struct {
	Entity string         `json:"entity" jsonschema:"artist | image"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GithubApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "github-api2_list",
		Description: "List records from GithubApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "github-api2_load",
		Description: "Load a single record from GithubApi2. " +
...
func runOp(client *sdk.GithubApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
