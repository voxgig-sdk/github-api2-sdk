// Command GithubApi2-mcp is an MCP server exposing the GithubApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GithubApi2_list  — list records of an entity
//	GithubApi2_load  — load a single record of an entity
//
